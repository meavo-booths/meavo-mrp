# Meavo Stock — Accounts Checklist
...
- Create a private repository named `meavo-stock`
...
## 2. Vercel — _Pro trial → Pro after trial_

- Sign up at <https://vercel.com> with GitHub login
...
## 4. Google AI Studio (Gemini API) — _free tier first_
...
## 5. Google Cloud Console — _free, for Google SSO only_

- Sign up / sign in at <https://console.cloud.google.com>
- Create a new project (e.g. `meavo-stock-auth`)
...
## 6. Microsoft Entra (Azure portal) — _optional, only if Microsoft 365 SSO_
...
## 7. Domain (existing — no signup) — _free if you already own it_
...
## 8. (Optional, later) Sentry — _free tier_
